...
| S4 | **Tokenisation** | `ClassifiedRegions` → `Candidates` | Nutrition: candidate (label, value, unit) triples with column association. Ingredients: delimiter split respecting parentheses. |
